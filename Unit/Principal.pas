...
begin
  ...
  vQueryAux.Connection := AdcBaseDados;
  try
    vQueryAux.Close;
    vQueryAux.SQL.Clear;
    vQueryAux.SQL.Add('SELECT E.CODIGOEMPRESA, E.ALIAS, E.NOMEEMPRESA FROM DGLOB000 E');
    vQueryAux.SQL.Add('WHERE E.CODIGOEMPRESA = :CODIGOEMPRESA;');

    vQueryAux.ParamByName('CODIGOEMPRESA').AsInteger := StrToInt(vCodigoEmpresa);
    vQueryAux.Open;
    vQueryAux.FetchAll;
    vQueryAux.First;

    Result := vQueryAux.FieldByName('ALIAS').AsString;
  finally
